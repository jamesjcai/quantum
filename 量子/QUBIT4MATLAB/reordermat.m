...
%
%    reordermat([2 1],[3 2]) corresponds to not changeing the order
%                            of a qutrit and a qubit (i.e., doing nothing)
%
%    reordermat([1 2],[3 2]) corresponds to flipping a qutrit 
%                            and a qubit
...
if length(base)==1
    ...
    % All qudits have the same dimension
