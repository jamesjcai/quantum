% wvar_dpt   Wasserstein variance
%    Obtained via a maximization over quantum states.
%    Parameters: wvar_dpt(rho,sigma,H), where
...
%    [distance,diagnostic,coupling]=wvar_dpt(rho,sigma,H)
...
function [optimum,diagnostic,coupling]=wvar_dpt(rho,sigma,H)
