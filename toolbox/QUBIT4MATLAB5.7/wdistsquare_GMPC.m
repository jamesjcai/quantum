...
%   Parameters: wdistsquare_GMPC(rho,sigma,H), where
...
%   [distance,diagnostic,coupling]=wdistsquare_GMPC(rho,sigma,H)
...
function [optimum,diagnostic,coupling]=wdistsquare_GMPC(rho,sigma,H)
