% wvar_GCMP   Wasserstein GMPC variance
%    Obtained via a maximization over quantum states.
%    Parameters: wvar_GCMP(rho,sigma,H), where
...
%    distance,diagnostic,coupling]=wvar_GCMP(rho,sigma,H)
...
function [optimum,diagnostic,coupling]=wvar_GMPC(rho,sigma,H)
