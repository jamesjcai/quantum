% wvar_dpt_ppt   Wasserstein variance
%    Obtained via a maximization over PPT states.
%    For two qubits, this is the same as the maximization
%    over separable states.
%    Parameters: wvar_dpt_ppt(rho,sigma,H), where
...
%    distance,diagnostic,coupling]=wvar_dpt_ppt(rho,sigma,H)
%    Here, coupling is the bipartite state corresponding
%    to the maximum of the optmization problem.
...
function [optimum,diagnostic,coupling]=wvar_dpt_ppt(rho,sigma,H)
