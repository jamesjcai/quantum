% wdistsquare_dpt_ppt   Wasserstein distance square.
%    Obtained via a minimization over PPT states.
%    For two qubits, this is the same as the minimization
%    over separable states.
%    Parameters: wdistsquare_dpt_ppt(rho,sigma,H), where
...
%    [distance,diagnostic,coupling]=wdistsquare_dpt_ppt(rho,sigma,H)
...
function [optimum,diagnostic,coupling]=wdistsquare_dpt_ppt(rho,sigma,H)
