...
%   For two qubits, this is the same as the minimzation
%   over separable states.
%   Parameters: wdistsquare_GMPC_ppt(rho,sigma,H), where
...
%   [distance,diagnostic,coupling]=wdistsquare_GMPC_ppt(rho,sigma,H)
...
function [optimum,diagnostic,coupling]=wdistsquare_GMPC_ppt(rho,sigma,H)
